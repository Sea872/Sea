...
/**
 * Site-wide 3D hero background. Renders the WebGL scene when it is supported
...
export function HeroBackground() {
  ...
  return (
    <div aria-hidden="true" className="fixed inset-0 -z-10">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_45%,#0a2a44_0%,#04121f_55%,#020814_100%)]" />
      {enabled && (
